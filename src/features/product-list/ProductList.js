...
const sortOptions = [
  ...
  { name: "Price: Low to High", href: "price", order: "asc", current: false },
  { name: "Price: High to Low", href: "price", order: "desc", current: false },
];
const subCategories = [
  { name: "Totes", href: "#" },
  { name: "Backpacks", href: "#" },
...
export default function ProductList() {
  ...
  useEffect(() => {
    dispatch(fetchAllProductAsync(filter));
  }, [dispatch,filter]);
